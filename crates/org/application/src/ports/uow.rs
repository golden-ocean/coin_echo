...
use crate::ports::{
    organization_repository::OrganizationRepository, position_repository::PositionRepository,
};
...
impl ErrorMeta for UnitOfWorkError {
    ...
    fn code(&self) -> &'static str {
        match self {
            Self::Connection => "org.uow.connection_failed",
            Self::Commit => "org.uow.commit_failed",
            Self::Rollback => "org.uow.rollback_failed",
            Self::Begin => "org.uow.begin_failed",
            Self::TransactionClosed => "org.uow.transaction_closed",
        }
    }
}
